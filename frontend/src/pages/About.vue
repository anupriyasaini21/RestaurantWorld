<template>
    <section class="about-section">
        <div class="heading">
            <span>about us</span>
            <h3>quality cuisine experience</h3>
        </div>
        ...
        <div class="row">
            <div class="about-article">
                <h3>great food, great moments</h3>
            </div>
        </div>
